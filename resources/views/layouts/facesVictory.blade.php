            ...
            @if(count($facesVictory) > 0)
                <div class="image-container">
                    @foreach($facesVictory as $faceVictory)
                        ...
                        <div class="wrap">
                            <div class="globalImage" data-fio="{{ $faceVictory->last_name . ' ' . $faceVictory->first_name . ' ' . $faceVictory->patronymic }}" data-description="{!!   htmlspecialchars($faceVictory->description) !!}">
