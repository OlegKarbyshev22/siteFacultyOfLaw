        ...
        <div class="container">
            <div class="wrapper">
                <a class="main_link" href="{{route('news.main')}}">
                    ...
                    <h1 class="header__title">50 лет Юридическому образованию Ульяновской области</h1>
                </a>

                <div class="header__nav">
                    <nav>
                        <ul>
                            <li><a class="header__link" href="/legalEducation" onclick="">Юридическое образование Ульяновской области в контексте времени</a></li>
                            <li><a class="header__link" href="/facesVictory">Лица победы</a></li>
                            <li><a class="header__link" href="/challenges_new_age">Вызовы нового времени</a></li>
